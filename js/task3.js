...
let result2 = document.querySelector(`.stoneScissorsPapierResult`);
...
stone.addEventListener(`click`, function () {
  ...
  if (num === 1) {
    ...
    result2.textContent = `Нічия! Спробуй ще раз!`;
  } else if (num === 2) {
    pScore.textContent = `Ви - ${userScore++}`;

    result2.style.color = `green`;
    result2.textContent = `Вітаю! Ви виграли раунд!`;
  } else if (num === 3) {
    cScore.textContent = `Комп’ютер - ${computerScore++}`;

    result2.style.color = `red`;
    result2.textContent = `Комп’ютер виграв раунд!`;
  }
});
